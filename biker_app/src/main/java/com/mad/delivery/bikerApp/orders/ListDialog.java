...
public class ListDialog extends DialogFragment {
    ...
    public static List<String> getStatusAsList(OrderStatus initial) {
        ...
        switch(initial) {
            case pending:
                list.addAll(Arrays.asList(OrderStatus.preparing.toString(), OrderStatus.ready.toString(), OrderStatus.completed.toString(), OrderStatus.delivered.toString()));
                break;
            case preparing:
                list.addAll(Arrays.asList(OrderStatus.ready.toString(), OrderStatus.completed.toString(), OrderStatus.delivered.toString()));
                break;
            case ready:
                list.addAll(Arrays.asList(OrderStatus.completed.toString(), OrderStatus.delivered.toString()));
                break;
            case completed:
                list.addAll(Arrays.asList(OrderStatus.completed.toString(), OrderStatus.delivered.toString()));
                break;
            case delivered:
                ...
                break;
            default:
                list.addAll(Arrays.asList(OrderStatus.pending.toString(), OrderStatus.preparing.toString(), OrderStatus.ready.toString(), OrderStatus.completed.toString(), OrderStatus.delivered.toString()));
        }
        return list;
    }
